...
export const OVERRIDE_CONVEX_DEPLOY_KEY_ENV_VAR_NAME =
  "OVERRIDE_CONVEX_DEPLOY_KEY";
export const OVERRIDE_CONVEX_DEPLOYMENT_URL_ENV_VAR_NAME =
  "OVERRIDE_CONVEX_DEPLOYMENT_URL";
export const OVERRIDE_CONVEX_DEPLOYMENT_NAME_ENV_VAR_NAME =
  "OVERRIDE_CONVEX_DEPLOYMENT_NAME";
export const OVERRIDE_CONVEX_PREVIEW_NAME_ENV_VAR_NAME =
  "OVERRIDE_CONVEX_PREVIEW_NAME";
export const OVERRIDE_CONVEX_TEAM_SLUG_ENV_VAR_NAME =
  "OVERRIDE_CONVEX_TEAM_SLUG";
export const OVERRIDE_CONVEX_PROJECT_SLUG_ENV_VAR_NAME =
  "OVERRIDE_CONVEX_PROJECT_SLUG";
